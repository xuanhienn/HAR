function [dense_1, state] = modelHAR(conv1d_input, params, varargin)
%MODELHAR Function implementing an imported ONNX network.
%
...
%
% [DENSE_1] = modelHAR(CONV1D_INPUT, PARAMS)
%			- Evaluates the imported ONNX network MODELHAR with input(s)
%			CONV1D_INPUT and the imported network parameters in PARAMS. Returns
%			network output(s) in DENSE_1.
%
% [DENSE_1, STATE] = modelHAR(CONV1D_INPUT, PARAMS)
%			- Additionally returns state variables in STATE. When training,
%			use this form and set TRAINING to true.
%
% [__] = modelHAR(CONV1D_INPUT, PARAMS, 'NAME1', VAL1, 'NAME2', VAL2, ...)
...
%				  CONV1D_INPUT:		[unk__114, 60, 6]				Type: FLOAT
...
% Unsqueeze:
[shape, NumDims.sequential_conv1d_Conv1D_ExpandDims_0] = prepareUnsqueezeArgs(Vars.conv1d_input, Vars.const_fold_opt__113, NumDims.conv1d_input);
Vars.sequential_conv1d_Conv1D_ExpandDims_0 = reshape(Vars.conv1d_input, shape);

% Transpose:
[perm, NumDims.sequential_conv1d_Conv1D__61_0] = prepareTransposeArgs(Vars.TransposePerm1001, NumDims.sequential_conv1d_Conv1D_ExpandDims_0);
if ~isempty(perm)
    Vars.sequential_conv1d_Conv1D__61_0 = permute(Vars.sequential_conv1d_Conv1D_ExpandDims_0, perm);
end

% Conv:
[weights, bias, stride, dilationFactor, padding, dataFormat, NumDims.sequential_conv1d_Conv1D_0] = prepareConvArgs(Vars.sequential_conv1d_Conv1D_ExpandDims_1_0, '', Vars.ConvStride1002, Vars.ConvDilationFactor1003, Vars.ConvPadding1004, 1, NumDims.sequential_conv1d_Conv1D__61_0, NumDims.sequential_conv1d_Conv1D_ExpandDims_1_0);
Vars.sequential_conv1d_Conv1D_0 = dlconv(Vars.sequential_conv1d_Conv1D__61_0, weights, bias, 'Stride', stride, 'DilationFactor', dilationFactor, 'Padding', padding, 'DataFormat', dataFormat);

% Squeeze:
[Vars.sequential_conv1d_Conv1D_Squeeze_0, NumDims.sequential_conv1d_Conv1D_Squeeze_0] = onnxSqueeze(Vars.sequential_conv1d_Conv1D_0, Vars.axes_const__65__90, NumDims.sequential_conv1d_Conv1D_0);

% Add:
Vars.sequential_conv1d_BiasAdd_0 = Vars.sequential_conv1d_Conv1D_Squeeze_0 + Vars.const_fold_opt__112;
NumDims.sequential_conv1d_BiasAdd_0 = max(NumDims.sequential_conv1d_Conv1D_Squeeze_0, NumDims.const_fold_opt__112);
...
% Shape:
[Vars.Shape__103_0, NumDims.Shape__103_0] = onnxShape(Vars.sequential_conv1d_BiasAdd_0, NumDims.sequential_conv1d_BiasAdd_0);

% Gather:
[Vars.sequential_lstm_Shape_0, NumDims.sequential_lstm_Shape_0] = onnxGather(Vars.Shape__103_0, Vars.Const__105, 0, NumDims.Shape__103_0, NumDims.Const__105);

% Cast:
Vars.sequential_lstm_Shape__66_0 = cast(int32(extractdata(Vars.sequential_lstm_Shape_0)), 'like', Vars.sequential_lstm_Shape_0);
NumDims.sequential_lstm_Shape__66_0 = NumDims.sequential_lstm_Shape_0;

% Slice:
[Indices, NumDims.sequential_lstm_strided_slice_0] = prepareSliceArgs(Vars.sequential_lstm_Shape__66_0, Vars.const_axes__86, Vars.const_axes__49, Vars.const_axes__86, '', NumDims.sequential_lstm_Shape__66_0);
Vars.sequential_lstm_strided_slice_0 = subsref(Vars.sequential_lstm_Shape__66_0, Indices);

% Concat:
[Vars.sequential_lstm_zeros_1_packed_Concat__1, NumDims.sequential_lstm_zeros_1_packed_Concat__1] = onnxConcat(0, {Vars.sequential_lstm_strided_slice_0, Vars.const_fold_opt__110}, [NumDims.sequential_lstm_strided_slice_0, NumDims.const_fold_opt__110]);

% Cast:
Vars.sequential_lstm_zeros__83_0 = cast(int64(extractdata(Vars.sequential_lstm_zeros_1_packed_Concat__1)), 'like', Vars.sequential_lstm_zeros_1_packed_Concat__1);
NumDims.sequential_lstm_zeros__83_0 = NumDims.sequential_lstm_zeros_1_packed_Concat__1;

% Expand:
[shape, NumDims.sequential_lstm_zeros_0] = prepareExpandArgs(Vars.sequential_lstm_zeros__83_0);
Vars.sequential_lstm_zeros_0 = Vars.sequential_lstm_zeros_Const_0 + zeros(shape);

% Unsqueeze:
[shape, NumDims.Unsqueeze__38_0] = prepareUnsqueezeArgs(Vars.sequential_lstm_zeros_0, Vars.const_axes__86, NumDims.sequential_lstm_zeros_0);
Vars.Unsqueeze__38_0 = reshape(Vars.sequential_lstm_zeros_0, shape);

% LSTM:
[H0, C0, WEIGHTS, RECURRENTWEIGHTS, BIAS, NumDims.LSTM__46_0, NumDims.LSTM__46_1, NumDims.LSTM__46_2] = prepareLSTMArgs(Vars.W0__43, Vars.R0__44, Vars.B0__45, '', Vars.Unsqueeze__38_0, Vars.Unsqueeze__38_0, '');
[Vars.LSTM__46_0, Vars.LSTM__46_1, Vars.LSTM__46_2] = lstm(Vars.sequential_lstm_PartitionedCall_transp_1, H0, C0, WEIGHTS, RECURRENTWEIGHTS, BIAS, 'DataFormat', 'CBT');
[C, B, T] = size(Vars.LSTM__46_0, 1:3);
Vars.LSTM__46_0 = reshape(Vars.LSTM__46_0, [C B 1 T]);

% Squeeze:
[Vars.Squeeze__50_0, NumDims.Squeeze__50_0] = onnxSqueeze(Vars.LSTM__46_0, Vars.const_axes__49, NumDims.LSTM__46_0);

% Slice:
[Indices, NumDims.sequential_lstm_PartitionedCall_stride_1] = prepareSliceArgs(Vars.Squeeze__50_0, Vars.const_starts__84, Vars.const_ends__85, Vars.const_axes__86, '', NumDims.Squeeze__50_0);
Vars.sequential_lstm_PartitionedCall_stride_1 = subsref(Vars.Squeeze__50_0, Indices);

% Squeeze:
[Vars.sequential_lstm_PartitionedCall_stride_3, NumDims.sequential_lstm_PartitionedCall_stride_3] = onnxSqueeze(Vars.sequential_lstm_PartitionedCall_stride_1, Vars.const_axes__86, NumDims.sequential_lstm_PartitionedCall_stride_1);
...
% Function to validate inputs to modelHAR:
p = inputParser;
...
% Check input size(s):
checkInputSize(size(conv1d_input), {'unk__114' 60 6}, "conv1d_input");
end
