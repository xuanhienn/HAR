function [dense_1, state] = modelHAR3(conv1d_input, params, varargin)
%MODELHAR3 Function implementing an imported ONNX network.
%
...
%
% [DENSE_1] = modelHAR3(CONV1D_INPUT, PARAMS)
%			- Evaluates the imported ONNX network MODELHAR3 with input(s)
%			CONV1D_INPUT and the imported network parameters in PARAMS. Returns
%			network output(s) in DENSE_1.
%
% [DENSE_1, STATE] = modelHAR3(CONV1D_INPUT, PARAMS)
%			- Additionally returns state variables in STATE. When training,
%			use this form and set TRAINING to true.
%
% [__] = modelHAR3(CONV1D_INPUT, PARAMS, 'NAME1', VAL1, 'NAME2', VAL2, ...)
...
% Function to validate inputs to modelHAR3:
p = inputParser;
